...
def generate_launch_description():
    ...
    robot_description_semantic_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare("robot2_moveit_config"), "srdf", "robot2.srdf.xacro"]
            ),
            " ",
            "prefix:=",
            prefix,
    ...
    joint_limits_yaml = load_yaml("robot2_moveit_config", "config/joint_limits.yaml")
    ...
    moveit_controllers = load_yaml("robot2_moveit_config", "config/moveit_controllers.yaml")
