...
def generate_launch_description():
    ...
    robot_description_semantic_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare("robot1_moveit_config"), "srdf", "robot1.srdf.xacro"]
            ),
            " ",
            "prefix:=",
            prefix,
    ...
    kinematics_yaml = load_yaml("robot1_moveit_config", "config/kinematics.yaml")
    robot_description_kinematics = {"robot_description_kinematics": kinematics_yaml}

    # Joint limits config (passed as dict)
    joint_limits_yaml = load_yaml("robot1_moveit_config", "config/joint_limits.yaml")
    robot_description_planning = {"robot_description_planning": joint_limits_yaml}

    # OMPL Planning Pipeline
    ompl_planning_yaml = load_yaml("robot1_moveit_config", "config/ompl_planning.yaml")
    ...
    moveit_controllers = load_yaml("robot1_moveit_config", "config/moveit_controllers.yaml")
